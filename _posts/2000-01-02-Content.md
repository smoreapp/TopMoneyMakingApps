...
While most of the items on this list will earn you money by using your phone, S’more actually requires that you don’t use it for a while.
...
Of course, the caveat is that you actually need to put your phone down for the points to start rolling in. At the very least, this should allow you to collect points for six to eight hours a night while you sleep.

While you might assume an app that is constantly running on your phone - even when the phone isn’t in use, would quickly drain the battery. Luckily, S’more’s programmers developed the app specifically so that this wouldn’t be an issue. 

Unfortunately, because of restrictions in Apple’s terms of service, S’more is currently only available for Android users. 

I wonder if it’d be worth it to purchase an Android device and simply leave it on with S’more running all day, every day. It must end up paying for itself in the long run, right?
